...
sudo apt install pika-gameutils-meta pika-gameutils-meta-extra ttf-mscorefonts-installer blender obs-studio pika-libreoffice-meta fabiscafe-devices xone-dkms xpadneo-dkms xpad-noone-dkms -y #install welcome apps
echo ""
...
EXTENSIONS="615 3628 1401 4839 1160 2087 841 1319 750 19 5547 4998"
